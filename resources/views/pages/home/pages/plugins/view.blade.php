<div>
    <div class="flex flex-col lg:flex-row w-full">
        ...
        <div class="flex flex-col w-full min-h-screen prose-h2:mb-0 prose-p:mb-0 prose-pre:mb-0 px-4 my-4 prose lg:border-s border-secondary-light/50 dark:border-secondary-dark/50 text-start text-dark dark:text-light dark:prose-invert"
